...
public class RabbitMQConfig {
    ...
    @Bean
    public Binding fineGeneratedBinding(Queue notificationQueue, TopicExchange exchange) {
        return BindingBuilder.bind(notificationQueue).to(exchange).with("fine.penalty.generated");
    }
